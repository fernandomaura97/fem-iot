...
//Sample Multichannel gas sensor
    ...
    snprintf(nh3_, sizeof(nh3_),"nh3: %d.%s\n", (int)c__, &fractional_part[1]);
...
*/
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(co_, sizeof(co_),"co: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(no2_, sizeof(no2_),"no2: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(c3h8_, sizeof(c3h8_),"c3h8: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    */
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(c4h10_, sizeof(c4h10_),"c4h10: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(ch4_, sizeof(ch4_),"ch4: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(h2_, sizeof(h2_),"h2: %d.%s\n", (int)c__, &fractional_part[1]);
    ...
    sprintf(fractional_part, "%d", (int)((c__ - (int)c__ + 1.0) * 1000));
    snprintf(c2h5oh_, sizeof(c2h5oh_),"c2h5oh: %d.%s\n", (int)c__, &fractional_part[1]);
